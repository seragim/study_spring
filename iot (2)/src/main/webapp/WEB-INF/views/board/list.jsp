...
<div>
	...
	<ul>
		<li><select name="pageList" class="w-px80" onchange="$('[name=curPage]').val(1); $('form').submit()">
...
$(function(){
	...
	var height = (( len % 5 > 0 ? 1 : 0 ) + Math.floor(len / 5)) * $('.grid li').outerHeight(true) - 20;
	
	$('#data-list ul').css('height', height );
});
</script>
</body>
</html>