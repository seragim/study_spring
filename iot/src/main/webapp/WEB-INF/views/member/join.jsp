...
<tr><th>생년월일</th>
	<td><input type='text' name='birth' readonly/><span id="delete" style="display:none; position: relative; right: 25px; cursor: pointer;"><i class="far fa-times-circle"></i></span></td>
</tr>
<tr><th>연락처</th>
